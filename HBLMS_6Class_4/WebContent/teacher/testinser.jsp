<%@page import="com.lms.dto.ProjectDto"%>
	...
	<div class="container">
		...
		<div class="content row">
			...
			<div class="main">
				<div class="path">
					<p>
						<a href="./../main">HOME</a> > <a href="./../mypage">마이페이지</a> >
						성적관리
					</p>
				</div>
				<form action="./gradeinsert">
					<table>
						...
						<tr class="file">
							<td>파일명</td>
							<td colspan="3"><a target="_self"
								href="./../download.jsp?filename=${dto.proorin }">${dto.proorin }</a></td>
						</tr>
						<tr class="gradeP">
							<td rowspan="2">성적</td>
							...
							<c:if test="${dto.grade ne 0 }">
								<!-- empty가 아닌걸로 -->
								<td colspan="3"><input type="text" name="grade" id="grade"
									value="${dto.grade }"></td>
							</c:if>
						</tr>
						<input type="text" name="testid" id="testid" value="${dto.testid}"
							hidden="hidden">
						<input type="text" name="id" id="id" value="${dto.id}"
							hidden="hidden">
						<input type="text" name="proid" id="proid" value="${proid}"
							hidden="hidden">
						<input type="text" name="proname" id="proname" value="${dto.proname}"
							hidden="hidden">
						<tr class="okBtn">
							<td colspan="3"><button type="submit">입력</button>
